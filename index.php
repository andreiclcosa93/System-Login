...
if( isset($_SESSION['userId'])){
	...
	if( $user->role === 'guest'){
		...
		$message = "your role is a moderator";
...
?>
	...
	<div class="container">
		<div class="card bg-light mb-3">
								...
								<select name="userInfo">
									<?php if($loopUser->role == "moderator") { ?>
										...
										<option value="guest">Guest</option>
									 	<?php } elseif ($looper->role == "guest") {  ?>
									 		<option selected="selected" value="guest">Guest
									 		</option>
			...
			<?php } ?>
				<?php if(isset($user)) { ?>
					<h5>This is a super secret content only for logged in poeple</h5>
				<?php } else { ?>
